...
from omegafold.utils.protein_utils.residue_constants import restypes
warnings.filterwarnings('ignore')

def string_to_one_hot(string, vocabulary):
...
class OneHotOpt(Env):
  def __init__(self, args):
    ...
    self.observation_space = spaces.Box(low=0, high=1, shape=(args.seq_len, 20))
  ...
  def reset(self):
    ...
    return string_to_one_hot(self.sequence, restypes)
  ...
  def step(self, action):
    ...
    self.state = string_to_one_hot(self.sequence, restypes)
